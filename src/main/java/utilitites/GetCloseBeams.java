...
public class GetCloseBeams {
	...
	public static void getCloseBeams(String arg1, String arg2) throws FileNotFoundException {
		MetaFile metafile1 = ApsuseMetaReader.parseFile(arg1);
		MetaFile metafile2 = ApsuseMetaReader.parseFile(arg2);
